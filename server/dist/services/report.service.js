 ...
 */
async function getTotalGroundsByUser(userId) {
    try {
 ...
 */
async function getGroundAvailabilityStats() {
    try {
 ...
 */
async function getGroundUtilizationReport(groundId) {
    try {
 ...
 */
async function getAvailableGroundsWithBlockedSlots() {
    try {
